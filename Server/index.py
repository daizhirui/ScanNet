...
def extract_meta(dirname, subdir, args):
    ...
    meta1 = {"fullId": source + "." + id, "id": id, "source": source, "datasets": datasets, "path": subdir}
    if times is not None:
...
def main():
    ...
    parser.add_argument("-o", "--output", dest="output", action="store", help="Output CSV filename")
    parser.add_argument(
        "-s",
        "--single",
        dest="single",
    ...
    parser.add_argument("-a", "--append", dest="append", action="store_true", default=False, help="Append to output")
    parser.add_argument(
        "--all",
        dest="includeAll",
        action="store_true",
    ...
    parser.add_argument("--datasets", dest="datasets", action="store", default="ScanNet", help="Name of dataset")
    parser.add_argument(
        "--stages",
        dest="stagesFile",
        action="store",
    ...
    parser.add_argument("--source", dest="source", action="store", default="scan", help="Source to use for fullId")
    parser.add_argument(
        "--format",
        dest="format",
        action="store",

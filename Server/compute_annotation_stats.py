    ...
    stats.update(
        {
            ...
            "percentComplete": 100 * stats.get("annotatedVertices") / stats.get("totalVertices")
...
def main():
    ...
    parser.add_argument(
        "-a", "--annotations", dest="annotations", help="Json file with all annotations", action="store"
    )
    ...
    parser.add_argument(
        "-f", "--format", dest="format", default="csv", help="Output format", choices=["json", "csv"], action="store"
    )
